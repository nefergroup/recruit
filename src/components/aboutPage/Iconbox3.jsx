        ...
        <div className="row">
          ...
          <div className="col-lg-6 col-md-12 content-tab wow fadeInRight">
            <div className="wd-review-job contentbox1">
              ...
              <p>
               Explore verified international opportunities and build your career abroad with Recruit Plus, powered by Vision 360. Find high-demand roles in construction, welding, electrical, and industrial sectors across Europe and the Middle East — with full support from training to placement.
              </p>
              <ul className="wd-list-icon">
                <li>
                  ...
                  Access to thousands of global job openings in trusted companies.
                </li>
                <li>
                  <span className="icon">
                    <svg
                 ...
                 Only genuine, licensed recruitment with transparent processes.
                </li>
                <li>
                  <span className="icon">
                    <svg
              ...
              Free registration and career guidance for certified candidates.
                </li>
                <li>
                  <span className="icon">
                    <svg
                ...
                Guaranteed interviews for SkillGrow-trained professionals.
                </li>
                <li>
                  <span className="icon">
                    <svg
              ...
              Complete visa and relocation support handled by our team.
                </li>
              </ul>
            </div>
          </div>
